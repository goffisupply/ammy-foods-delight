  ...
  return (
    <section id="home" className="pt-24 pb-12 md:pt-32 md:pb-20 relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute -top-20 left-1/2 -translate-x-1/2 text-[180px] font-bold opacity-5 text-primary hidden md:block whitespace-nowrap transform -rotate-6">
          DELICIOUS FOOD
        </div>
      </div>
